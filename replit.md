...
- January 10, 2025. Successfully restored and expanded dive site database to 9 total sites after accidental deletion. Added Twin Peaks and Turtle Bommie as new Great Barrier Reef locations with comprehensive species associations. Restored AMMO Jetty (Western Australia artificial reef) and Blackwall Reach (Swan River urban diving) with appropriate riverine species. Database now includes authentic water conditions, marine species associations, and detailed site information for all locations.
