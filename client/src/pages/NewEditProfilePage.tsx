...
export default function NewEditProfilePage() {
  ...
  // Show current user data for verification
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Debug info - show current user data */}
        {user && (
          <Card className="mb-6 bg-blue-50">
            <CardHeader>
              <CardTitle className="text-sm text-blue-700">Current User Data (for verification)</CardTitle>
            </CardHeader>
            <CardContent className="text-sm">
              <p><strong>Name:</strong> {user.name}</p>
              <p><strong>Last Name:</strong> {user.lastname}</p>
              <p><strong>Email:</strong> {user.email}</p>
              <p><strong>Activity:</strong> {user.preferredActivity}</p>
              <p><strong>Country ID:</strong> {user.countryId}</p>
